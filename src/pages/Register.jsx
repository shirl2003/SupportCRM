...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name || !email || !phone_number || !password) { setError("All fields are required"); return; }
    setError("");
    setLoading(true);
    try {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[44%] bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-800 flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative text-center max-w-xs">
          ...
          <h1 className="text-2xl font-bold text-white mb-2">Join the Platform</h1>
          <p className="text-indigo-200 text-sm leading-relaxed">
            Create your account and start managing customer support tickets effectively.
          </p>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 bg-gray-50 focus:bg-white transition-all"
                  />
                </div>
                <div>
